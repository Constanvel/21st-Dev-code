...
const IMG = "?q=80&w=1000&auto=format&fit=crop";

const slides: Slide[] = [
  {
    image: `https://images.unsplash.com/photo-1506905925346-21bda4d32df4${IMG}`,
    title: "Mountain Trek",
    description: "Scale new heights and embrace the hiker's journey.",
    badge: "Adventure",
  },
  {
    image: `https://images.unsplash.com/photo-1544735716-392fe2489ffa${IMG}`,
    title: "River Rafting",
    description: "Feel the adrenaline rush as you navigate the wild rapids.",
    badge: "Extreme",
  },
  {
    image: `https://images.unsplash.com/photo-1441974231531-c6227db76b6e${IMG}`,
    title: "Forest Walk",
    description: "Deep dive into the silence of the ancient woods.",
    badge: "Nature",
  },
  {
    image: `https://images.unsplash.com/photo-1507525428034-b723cf961d3e${IMG}`,
    title: "Azure Beach",
    description: "Unwind on the crystal clear shores of a tropical paradise.",
    badge: "Paradise",
  },
  {
    image: `https://images.unsplash.com/photo-1528181304800-259b08848526${IMG}`,
